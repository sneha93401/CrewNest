...
export const WorkspaceSidebar = () => {
  ...
  if (memberLoading || workspaceLoading || channelsLoading || membersLoading) {
    return (
      <div className="flex h-full flex-col items-center justify-center bg-[#6b9080]">
  ...
  if (!workspace || !member) {
    return (
      <div className="flex h-full flex-col items-center justify-center gap-y-2 bg-[#6b9080]">
  ...
  return (
    <div className="flex h-full flex-col gap-y-2 bg-[#004030] workspace_sidebar">
      <WorkspaceHeader
        workspace={workspace}
